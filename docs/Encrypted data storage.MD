...
2. [Decrypt, verify and retrieval data from the blockchain](#2-#decrypt-verify-and-retrieval-data-from-the-blockchain)
...
## 2. Decrypt, verify and retrieval data from the blockchain
