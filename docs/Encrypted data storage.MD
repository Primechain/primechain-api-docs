...
4. [Encrypt, sign and upload file](#4-encrypt-sign-and-upload-file)

5. [Decrypt and download file](#5-decrypt-and-download-file)
...
## 4. Encrypt, sign and upload file
